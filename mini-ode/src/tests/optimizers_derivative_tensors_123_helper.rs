...
fn test_derivative_tensors_123_case2() {
    ...
    let (grad, hessian, d3_tensor) = derivative_tensors_123(&|y| y.i(0)*y.i(0)+y.i(0)*y.i(1), &x).unwrap();
...
fn test_derivative_tensors_123_case3() {
    let x = Tensor::from_slice(&[5.0f32, 1.0f32]);
    let (grad, hessian, d3_tensor) = derivative_tensors_123(&|y| y.i(0)*y.i(1)*y.i(1) + y.i(0)*y.i(0)+y.i(0)*y.i(1), &x).unwrap();
